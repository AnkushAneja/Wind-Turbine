...
def getTurbLoc(turbine_loc_test):
    """ 
    ...
    df = pd.read_csv(turbine_loc_test, sep=',', dtype = np.float32)
    turb_coords = df.to_numpy(dtype = np.float32)
    return(turb_coords)


def loadPowerCurve(power_curve):
    """
    -**-THIS FUNCTION SHOULD NOT BE MODIFIED-**-
    ...
    """
    powerCurve = pd.read_csv(power_curve, sep=',', dtype = np.float32)
    powerCurve = powerCurve.to_numpy(dtype = np.float32)
    return(powerCurve)
    

def binWindResourceData(wind_data_2007):
    r"""
    -**-THIS FUNCTION SHOULD NOT BE MODIFIED-**-
...
if __name__ == "__main__":
    ...
    turb_coords   =  getTurbLoc(r'C:\Users\HP\Desktop\python lec\wind turbine\e976ac76f64e11ea\Wind Farm Evaluator\scores2.csv')
    
    # Load the power curve
    power_curve   =  loadPowerCurve(r'C:\Users\HP\Desktop\python lec\wind turbine\e976ac76f64e11ea\Wind Farm Evaluator\power_curve.csv')
    
    # Pass wind data csv file location to function binWindResourceData.
    # Retrieve probabilities of wind instance occurence.
    wind_inst_freq =  binWindResourceData(r'C:\Users\HP\Desktop\python lec\wind turbine\e976ac76f64e11ea\Wind Farm Evaluator\Wind Data\wind_data_2017.csv')   
